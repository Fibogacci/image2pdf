...
def main():
    parser = argparse.ArgumentParser(description="Convert PNG images in a folder to a PDF file, with each page sized to match the image.")
    parser.add_argument("-p", "--folder_path", help="Path to the folder containing PNG images.", required=True)
    parser.add_argument("-o", "--output", help="Name of the output PDF file.", default="output.pdf")
    ...
    for image_path in images:
        ...
        c.drawInlineImage(pil_image, x=0, y=0, width=img_width, height=img_height)
